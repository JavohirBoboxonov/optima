  ...
  return (
    <div className="landing">
      <div style={{ position: "relative" }}>
        ...
        <nav className="landing-nav">
          <div className="brand">
            ...
            <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 15, letterSpacing: "0.04em" }}>OPTIMA</div>
          </div>
        ...
        <div className="hero">
          <div className="eyebrow"><span style={{ width: 6, height: 6, borderRadius: "50%", background: "oklch(0.75 0.16 85)" }} />KELAJAK — OPTIMA</div>
          <h1>
            <span style={{ color: "white" }}>TIL VA MATNI</span><br />
      ...
      <div className="landing-footer">
        ...
        <div>&copy; 2026 Optima. Barcha huquqlar himoyalangan.</div>
      </div>
    </div>
  );
}
