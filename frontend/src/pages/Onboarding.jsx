    ...
    <div className="onb-wrap">
      <div className="onb-side">
        <div className="onb-side-top">
          ...
          <div>
            <div className="onb-brand">Optima</div>
            <div className="onb-tagline">Ta'lim. Aloqa. Rivojlanish.</div>
          </div>
        </div>
        <div className="onb-side-body">
          <h1>Optima'ga xush kelibsiz!</h1>
          <p>Optima — ta'lim, aloqa va hamkorlik uchun yaratilgan zamonaviy platforma. O'z maqsadingizga mos tarzda foydalanishni boshlang.</p>
        ...
        <div className="onb-content">
          ...
          {step === "welcome" && (
            <div className="onb-welcome-mobile">
              <div className="onb-illustration">optima illustratsiyasi</div>
              <h2>Optima'ga xush kelibsiz!</h2>
              <p className="onb-sub">Optima — ta'lim, aloqa va hamkorlik uchun yaratilgan zamonaviy platforma.</p>
          ...
          {step === "goal" && (
            <>
              ...
              <p className="onb-sub">Siz tanlagan maqsadga qarab, Optima sizga mos muhitni tayyorlaydi.</p>
          ...
          {step === "done" && (
            <div className="onb-done">
              ...
              <h2>Tayyor!</h2>
              <p className="onb-sub" style={{ textAlign: "center" }}>Sizga mos muhit tayyorlandi. Optima'da samarali va maroqli foydalaning!</p>
              <button className="btn btn-primary onb-next" onClick={finish} disabled={saving} type="button">
                {saving ? "..." : "Optima'ga kirish"}
              </button>
            </div>
          )}
        </div>
